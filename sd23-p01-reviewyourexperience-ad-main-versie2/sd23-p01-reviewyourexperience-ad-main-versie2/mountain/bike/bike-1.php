...
$query = $db->prepare('SELECT img FROM fietsen WHERE id = 4');
$query->execute();
...
$bike_id = 1; // Unieke id voor elke pagina
$errors = [];
$include = [];
...
<section class="container-fluid py-4">
    <div class="row">
        <div class="col-8"><img src="../../img/mountain/<?= $fiets->img?>" alt="bike-1" class="img-fluid product-img"></div>
        <div class="col-3 p-5">
            <p class="fs-2">Scalpel</p>
            <h2 class="fs-2">LAB71</h2>
            <h2 class="fs-2 fw-normal">€12,499</h2>
            <div class="col">
            ...
            <?php renderReviewFilterForm($filter_type, $start_date, $end_date, $min_rating, $reviewer_name, 'bike-1.php'); ?>
