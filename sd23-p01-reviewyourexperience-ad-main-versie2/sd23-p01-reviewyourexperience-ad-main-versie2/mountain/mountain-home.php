...
$query_1 = $db->prepare('SELECT img FROM fietsen WHERE id = 4');
$query_2 = $db->prepare('SELECT img FROM fietsen WHERE id = 5');
$query_3 = $db->prepare('SELECT img FROM fietsen WHERE id = 6');
            ...
            <div class="row py-5">
                <div class="col-md-4">
                    <a href="bike/bike-1.php">
                        <img src="../img/mountain/<?= $fiets_1->img?>" alt="" class="product-img img-fluid">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="bike/bike-2.php">
                        <img src="../img/mountain/<?= $fiets_2->img?>" alt="" class="product-img img-fluid">
                    </a>
                </div>
                <div class="col-md-4">            
                    <a href="bike/bike-3.php">
                        <img src="../img/mountain/<?= $fiets_3->img?>" alt="" class="product-img img-fluid">
                    </a>
                </div>
            </div>
        </div>
