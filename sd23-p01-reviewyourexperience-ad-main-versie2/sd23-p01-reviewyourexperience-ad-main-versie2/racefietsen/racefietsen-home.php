...
$query_1 = $db->prepare('SELECT img FROM fietsen WHERE id = 1');
$query_2 = $db->prepare('SELECT img FROM fietsen WHERE id = 2');
$query_3 = $db->prepare('SELECT img FROM fietsen WHERE id = 3');
...
<body>
    <!-- Navbar met logo en login -->
     <section class="container-fluid px-5 row">
            ...
            <div class="row py-5">
                <div class="col-md-4">
                    <a href="bike/bike-1.php">
                        <img src="../img/racefietsen/<?= $fiets_1->img?>" alt="" class="product-img img-fluid">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="bike/bike-2.php">
                        <img src="../img/racefietsen/<?=$fiets_2->img?>" alt="" class="product-img img-fluid">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="bike/bike-3.php">
                        <img src="../img/racefietsen/<?=$fiets_3->img?>" alt="" class="product-img img-fluid">
                    </a>
                </div>
            </div>
        </div>
