...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if ($e->getCode() == 23000) { // handle email error
            die("This email is already registered. Please use another.");
        } else {
    ...
    <div class="row justify-content-center d-flex">
        ...
        <div class="col-md-5 form-container">
            ...
            <form action="" method="POST">
                ...
                <button type="submit" class="btn btn-black btn-block sign-in-button">Create Account</button>
            </form>
        </div>
    </div>
</section>
