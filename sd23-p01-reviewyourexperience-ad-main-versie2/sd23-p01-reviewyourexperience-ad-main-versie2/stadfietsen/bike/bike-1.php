...
$query = $db->prepare('SELECT img FROM fietsen WHERE id = 7');
$query->execute();
...
if (isset($_POST['add_to_cart'])) {
    $cart_bike = [
        ...
        'price' => 15499,
        'quantity' => 1,
        'img_path' => '/sd23-p01-reviewyourexperience-ad-main-versie2/sd23-p01-reviewyourexperience-ad-main-versie2/img/stadfietsen/'
    ];
...
<section class="container-fluid py-4">
    <div class="row">
        <div class="col-8"><img src="../../img/stadfietsen/<?= $fiets->img?>" alt="bike-7" class="img-fluid product-img"></div>
        <div class="col-3 p-5">
